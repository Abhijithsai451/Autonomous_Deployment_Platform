...
inserted_roles_raw AS (
    INSERT INTO identity.roles (organization_id, name, system_role)
...
inserted_permissions_raw AS (
    INSERT INTO identity.permissions (name, resource, action) VALUES
...
inserted_sessions AS (
    INSERT INTO identity.sessions (user_id, device_name, ip_address, metadata, expires_at)
...
-- 9. SEED API_KEYS
INSERT INTO identity.api_keys (organization_id, service_account_id, hashed_key, expires_at)
